 ...
 */
public class CSFetchBot implements RoomServiceListener, RoomListener {


    private final static Logger logger = LoggerFactory.getLogger(CSFetchBot.class);
